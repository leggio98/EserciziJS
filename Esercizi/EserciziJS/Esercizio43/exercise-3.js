class NegativeAmountError extends Error {
  constructor(message){
    super(message)
    this.error = "NegativeAmountError"
  }
}
...
class WithdrawNotPermittedError extends Error {
  constructor(message){
    super(message)
    this.error ="WithdrawNotPermittedError"
  }
}
...
//Non ho capito perché cambiare le classi dei due errori
//Precedenti se poi alla fine usa il blocco try-catch
//e quindi risulta sempre la stessa cosa